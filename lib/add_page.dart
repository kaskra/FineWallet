  ...
  Widget _expenseCards(IconData icon, String label, int value, Function whathappensontap){    
    ...
    switch(value){
      case 0:
        ...
        break;
      case 1:
        valueString = _subcategory!=null?_subcategory.subcategoryLabel:"-";
            ...
            child:LayoutBuilder(builder: (context, constraint) {
              return Column(
                ...
                children: <Widget>[
                  ...
                  FittedBox(
                    child: Text(valueString, maxLines: 2,softWrap: false, style: TextStyle(fontSize: 15, color: Colors.black54)),
                  ),
                ]);
              },
            ),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          Container(
            ...
            child: InkWell(
              onTap: (){
                if (_expense != null && _date != null && _subcategory != null){
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            _expenseCards(Icons.euro_symbol, "Amount ${widget.isExpense==1?"Expense":"Income"}", 0 , setExpense),
