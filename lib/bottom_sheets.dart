        ...
        child: InkWell(
          child: Container(
            decoration: BoxDecoration(
              color: _subcategory?.index==index && _selectedCategory==_subcategory.selectedCategory?Colors.orange:Colors.white,
              border: Border.all(
          ...
          onTap: (){
            _subcategory = new Category(icons[_selectedCategory], name, index, selectedCategory: _selectedCategory);
...
Widget buildBottomPicker(Widget picker, double bottomSheetHeight, double topBorderHeight) => Container(
  decoration: BoxDecoration(
